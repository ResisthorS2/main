...
int MiniGame::finLocalASerge(int key[6], Engine *engine) {
    WhoState whoState;
    ...
    else
    {
        ...
        {
            whoState.who = "Serge";
            printSentence(whoState, "Ton robot n'est pas fini, t'es ground son dans les alims!");
            printSentence(whoState, "Tu me fais perdre mon temps!");
            printSentence(whoState, "DEHORS!");
            localASergeState = false;
            Sleep(3000);
        }
    }
...
int MiniGame::departLocalASerge(int key[6], Engine *engine) {
    WhoState whoState;
    bool localASergeState = true;
    while(localASergeState){
        whoState.who = "Serge";
